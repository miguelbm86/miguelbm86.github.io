...
<div id="banner-interno">
    <div class="caja-titulo-cabecera">
        <div class="titulo-cabecera">
            <h1>DELTATENT AL 25</h1>
            <div class="subtitulo-cabecera">
                <h2>Lorem ipsum dolor sit, amet</h2>
            </div>
        </div>  
    </div>    
    <img src="imagenes/tipos-coberturas/cabecera-deltatent.jpg" alt="">
</div>
<!-- ********************************************************************* -->
<!-- ************************  CUERPO  *********************** -->
<!-- ********************************************************************* -->
<section id="tipos-flexilona">
    <div class="caja-tipos1">
        <div class="caja-imagen-tipo1">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/deltatent.jpg" alt="">
            </div>
        ...
        <div class="text-tipo1">           
            <h1>DELTATENT AL 25</h1>          
            <p>Estructura compuesta por perfiles de aleación de aluminio, altamente resistente, no corrosivos, uniformes, de poco peso y de fácil transporte, son de categoría temporal, de base acticulada y se ancla en losa de concreto armado con plancha base y contrapesos con estacas de anclaje al suelo.
           </p> 
        </div>
    </div>
    ...
    <div class="caja-tipos2">
        ...
        <div class="caja-imagen-tipo2">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/deltatent2.jpg" alt="">
            </div>
            <div class="caja-cuadros">
                <div class="cuadros-tipos"></div>
                <div class="cuadros-tipos"></div>
