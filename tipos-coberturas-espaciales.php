    ...
    <div class="caja-titulo-cabecera">
        <div class="titulo-cabecera">
            ...
            <div class="subtitulo-cabecera">
                <h2>TENSIONADAS - DOMOS</h2>
            </div>
        </div>  
    </div>    
    <img src="imagenes/tipos-coberturas/cabecera2.jpg" alt="">
</div>
<!-- ********************************************************************* -->
<!-- ************************  CUERPO  *********************** -->
<!-- ********************************************************************* -->
<section id="tipos-flexilona">
    <div id="tensionadas" class="caja-tipos1">
        <div class="caja-imagen-tipo1">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/tensionadas.jpg" alt="">
            </div>
        ...
        <div class="text-tipo1">           
            <h1>TENSIONADAS</h1>          
            <p>Estructuras especiales, basadas en la optimización de la forma tensionada y requeridas por las grandes luces que se pueden mantener en esta configuración, permitiendo un alto flujo de unidades de bajo del área cubierta, facilitanto las operaciones de grandes equipos y maquinarias en el acopio, carga o descarga de minerales agregador y/o granos.</p> 
        </div>
    </div>

    <div id="domos" class="caja-tipos2">
        <div class="text-tipo2">           
            <h1>DOMOS</h1>           
            <p>La edificación de un domo es una moderna solución técnica, funcional y económica que cumple con estándares internacionales en el almacenamiento. Por la configuración radial que tienen generan en la superficie una doble curvatura, lo que hace que los esfuerzo que se generen en los elementos debido a las presiones y/o cargas, se transfiera de forma óptima, teniendo estructuras más ligeras y también logrando tener grandes luces o diámetros a cubrir bastante amplios.
            </p>  
        </div>
        <div class="caja-imagen-tipo2">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/domos.jpg" alt="">
            </div>
            <div class="caja-cuadros">
                <div class="cuadros-tipos"></div>
                <div class="cuadros-tipos"></div>
