    ...
    <div class="caja-titulo-cabecera">
        <div class="titulo-cabecera">
            ...
            <div class="subtitulo-cabecera">
                <h2>LIBRES DE POSTES CENTRALES</h2>
            </div>
        </div>  
    </div>    
    <img src="imagenes/tipos-coberturas/cabecera1.jpg" alt="">
</div>
<!-- ********************************************************************* -->
<!-- ************************  CUERPO  *********************** -->
<!-- ********************************************************************* -->
    ...
    <div class="caja-tipos1">
        <div class="caja-imagen-tipo1">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/deltaspan.jpg" alt="">
            </div>
        ...
        <div class="text-tipo1">           
            <h1>DELTASPAN</h1>          
            <p>Coberturas para emplazamientos provisionales.</br></br>
            Diseñado para traslados frecuentes y montajes rápidos.</br></br>
            Desarmables, fácil de almacenar y de transportar.</br></br>
            Cimentación provisional o fijaciones hacia losas de concreto o sobre contenedores metálicos.</br></br>
            Estructuras metálicas planas, livianas, desarmables.</br></br>
            Cerramientos desmontables reutilizables hecho de membrana de formulación reforzada de traslucidez suficiente para dejar pasar la luz solar y tener iluminación natural, pero al mismo tiempo crear el sombreamiento requerido para el confort de las personas.
        </div>
    </div>

    <div class="caja-tipos2">
        <div class="text-tipo2">           
            <h1>DELTASPAN MÓVIL</h1> 
            <p>Diseñado para proyectos temporales. Estos almacenes móviles se pueden trasladar a través de montacargas a lo largo de la zona que desean que se coloque. También pueden desarmarse y llevarse a otra obra.</br></br>
            Este tipo de almacén es práctico y el montaje es más rápido.</p> 
        </div>
        <div class="caja-imagen-tipo2">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/deltaspan-movil.jpg" alt="">
            </div>
            <div class="caja-cuadros">
                <div class="cuadros-tipos"></div>
                <div class="cuadros-tipos"></div>
...
<section id="beneficios">
    ...
    <a href="brochure-coberturas-industriales.pdf" download="brochure-coberturas-industriales.pdf" class="boton-brochure" target="_blank">BROCHURE DE PROYECTOS <i class="icon-download"></i></a> 
</section>
<!-- ******************************************************************* -->
<!-- ********************     NUESTROS PROYECTOS    ******************** -->
<!-- ******************************************************************* -->
