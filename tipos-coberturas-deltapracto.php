...
<div id="banner-interno">
    ...
    <img src="imagenes/tipos-coberturas/cabecera-deltapracto.jpg" alt="">
</div>
<!-- ********************************************************************* -->
<!-- ************************  CUERPO  *********************** -->
<!-- ********************************************************************* -->
<section id="tipos-flexilona">
    <div class="caja-tipos1">
        <div class="caja-imagen-tipo1">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/deltapracto.jpg" alt="">
            </div>
        ...
        <div class="text-tipo1">           
            <h1>DELTAPRACTO</h1>          
            <p>Coberturas para emplazamientos definidos pero aptas para trasladarse si se requiere.
            Grandes alturas y vanos.</br></br>
            Cimentación correspondiente según cálculos estructurales pero a los menores requisitos posible.</br></br>
            Estructuras metálicas livianas, desarmables y trasladables de sección triangular o rectangular.</br></br>
            Cerramientos desmontables y reutilizables con membrana de formulación reforzadas de traslucidez suficientes para dejar pasar la luz solar y tener iluminación natural, pero también el sombreamiento requerido para el confort de las personas y la conversación de los productos y máquinas.
            </p> 
        </div>
    </div>
    <!-- 
    <div class="caja-tipos2">
        <div class="text-tipo2">           
            <h1>DELTAPRACTO</h1>           
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error quo, sapiente veniam debitis excepturi maiores! A ab, officiis nihil, quia veritatis in eum numquam sapiente consectetur veniam quaerat voluptatem suscipit?</p> 
        </div>
        <div class="caja-imagen-tipo2">
            <div class="imagen-tipo">
                <img src="imagenes/tipos-coberturas/deltapracto2.jpg" alt="">
            </div>
            <div class="caja-cuadros">
                <div class="cuadros-tipos"></div>
                <div class="cuadros-tipos"></div>
